...
const QUESTIONS: Question[] = [
  ...
  },
  {
    id: 'q3',
    level: 'מתקדם',
    prompt: 'ב-qPCR התקבל Ct=18 בדגימה A ו-Ct=21 בדגימה B (עם אותו גן ייחוס). מה המשמעות?',
    options: [
      'בדגימה B יש יותר תבנית התחלתית',
      'בדגימה A יש פחות תבנית התחלתית',
      'בדגימה A יש יותר תבנית התחלתית',
      'אין קשר בין Ct לכמות תבנית'
    ],
    correctIndex: 2,
    explanation: 'Ct נמוך יותר מעיד על כמות התחלתית גבוהה יותר של מולקולת המטרה.'
  },
  {
    id: 'q4',
    level: 'בסיס',
  ...
  },
  {
    ...
    options: [
      ...
      'פס יחיד בדגימת מטרה',
      'ערך Ct גבוה מאוד בדגימה ענייה בתבנית'
    ],
    correctIndex: 1,
  ...
  },
  {
    id: 'q6',
    level: 'מתקדם',
    prompt: 'מה צפוי כשמעלים מאוד את ריכוז Mg2+ בתגובת PCR?',
    options: [
    ...
    correctIndex: 1,
    explanation: 'Mg2+ תומך בפעילות האנזים, אך עודף שלו עלול לפגוע בספציפיות.'
  },
  {
    id: 'q7',
    level: 'מתקדם',
    ...
    <div className="glass-pcr-card rounded-[2.5rem] border border-slate-700/30 p-6 md:p-8 space-y-6" dir="rtl">
      <div className="text-right space-y-3">
        <h2 className="text-3xl font-black text-white flex items-center gap-3 justify-start">
          ...
          משחק אתגר: עקרונות PCR ברמה גבוהה
        </h2>
