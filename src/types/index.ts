export type SimulationPhase = 'landing' | 'preparation' | 'pcr-running' | 'master-mixer-game' | 'replication-comparison' | 'genetic-fingerprint' | 'str-case-lab' | 'pcr-principles-game' | 'pcr-applications' | 'completed' | 'gene-expression-lab';
...
export const INGREDIENTS: Ingredient[] = [
  ...
  },
  {
    ...
    isRequired: true,
    feedbackText: 'יופי! תמיסת הבופר עשירה במגנזיום (Mg²⁺) ושומרת על pH מדויק שמבטיח פעילות אופטימלית של האנזים.'
  },
  {
    id: 'rna-pol',
    name: 'RNA פולימראז',
