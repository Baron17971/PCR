export type SimulationPhase = 'landing' | 'preparation' | 'pcr-running' | 'master-mixer-game' | 'replication-comparison' | 'genetic-fingerprint' | 'pcr-principles-game' | 'pcr-applications' | 'completed' | 'gene-expression-lab';
